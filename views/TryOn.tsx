...
const TryOn: React.FC = () => {
  ...
  return (
    <div className="relative h-full flex flex-col">
      ...
      <div className="mt-8 px-8 grid grid-cols-2 gap-4 z-20">
        <div className="bg-white/10 glass p-4 rounded-3xl text-white">
          <div className="flex justify-between items-start mb-6">
            <span className="material-icons-round text-primary">auto_fix_high</span>
            <div className="flex flex-col items-end">
              <span className="text-[10px] opacity-60 uppercase font-bold">Model ID</span>
              <span className="text-lg font-black">S-384x</span>
            </div>
          </div>
          <div className="flex flex-col">
            <span className="text-[10px] opacity-60 uppercase font-bold">Fit Score</span>
            <span className="text-2xl font-black">98.5%</span>
          </div>
        </div>
        <div className="bg-white/5 glass p-4 rounded-3xl flex flex-col">
          <span className="text-[10px] opacity-60 uppercase font-bold mb-2">Select Size</span>
